...
Assessment: 2026-09-11. This is a prioritization of the existing
[product roadmap](../PRODUCT_ROADMAP.md), not a change to its committed scope.
It is based on the repository's plans and retained verification reports; no
new runtime, editor, accessibility, or hardware checks were run for this audit.

...
- Source-rate-paced live-meter decoding with a hard 250 ms playback-clock admission bound and same-generation process suspension across pause and buffering, including cancellation-before-attachment, blocked-consumer and cancellation-while-stopped coverage. Authoritative compressed-source timestamps remain pending.
